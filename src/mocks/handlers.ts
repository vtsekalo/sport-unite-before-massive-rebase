...
export const handlers = [
  http.get('/api/v1/users/me', () => {
    console.log('[MSW] Mock: GET /api/v1/users/me');
    return HttpResponse.json(currentProfile);
  }),

  http.patch('/api/v1/users/update-profile-text', async ({ request }) => {
    console.log('[MSW] Mock: PATCH /api/v1/users/update-profile-text');
    ...
    try {
      ...
      console.error(
        '[MSW] Error in PATCH /api/v1/users/update-profile-text:',
        error,
      );
  ...
  http.patch('/api/v1/users/update-profile-avatar', async ({ request }) => {
    console.log('[MSW] Mock: PATCH /api/v1/users/update-profile-avatar');
    ...
    try {
      ...
      if (profilePicture instanceof File && profilePicture.size > 0) {
        try {
          ...
          console.error('[MSW] Error processing profile picture file:', error);
          return HttpResponse.json(
            {
      ...
      console.error(
        '[MSW] Error in PATCH /api/v1/users/update-profile-avatar:',
        error,
      );
  ...
  http.patch('/api/v1/users/updateMyProfile', async ({ request }) => {
    console.log('[MSW] Mock: PATCH /api/v1/users/updateMyProfile (legacy)');
    ...
    try {
      ...
      console.error(
        '[MSW] Error in legacy PATCH /api/v1/users/updateMyProfile:',
        error,
      );
